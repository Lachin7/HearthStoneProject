...
public class LearnDraconic extends Spell {
    public LearnDraconic(int manaCost, String name, String description, Card.rarity rarity, HeroClass heroClass, Card.type type, int price, String Quest, String Reward) {
